...
public class MovementController : MonoBehaviour
{
    ...
    [SerializeField]
    GameObject fpsCamera1;
    [SerializeField]
    GameObject fpsCamera2;
    ...
    private void Update()
    {
        ...
        isWalking = _xMovement != 0f || _zMovement != 0f;
    ...
    private void FixedUpdate()
    {
        ...
        if (fpsCamera1!=null && fpsCamera2 != null)
        {
            ...
            fpsCamera1.transform.localEulerAngles = new Vector3(CurrentCameraUpAndDownRotation,0,0);
            fpsCamera2.transform.localEulerAngles = new Vector3(CurrentCameraUpAndDownRotation, 0, 0);
